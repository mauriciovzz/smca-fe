...
const EnviromentalWidget = ({ dayReadings, selectedDate }) => {
  ...
  const getVariableIndex = (varialeIds) => dayReadings
    .findIndex((v) => `${v.component_id}${v.variable_id}` === varialeIds);
                            ...
                            >
                              {
                                (average.value)
                                  ? (
                                    <>
                                      <div className="self-center whitespace-nowrap text-xs">
                                        {(average.value) ? formatTime(average.time) : 'h'}
                                      </div>
                                      <div className="self-center whitespace-nowrap text-xs">
                                  ...
                                  : (
                                    <i className={`self-center text-lg ${getIcon(average.time)}`} />
                                  )
                              }
                            </div>
                          ))
