          ...
          <div className="absolute flex h-full w-full flex-col space-y-4">
            ...
            <form id="locationForm" className="space-y-4 md:space-y-6">
              ...
              <div className="flex justify-between space-x-4 ">
                <FormInput id="lat" type="number" labelName="Latitud" value={lat} setValue={setLat} disabled={true} />
                <FormInput id="long" type="number" labelName="Longitud" value={long} setValue={setLong} disabled={true} />
              </div>
